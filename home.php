    ...
    <div class="col-lg-12">
        <div class="card dashboard">
            <div class="card-body">
                ...
                <marquee behavior="alternate" style="color:red; font-weight: 400; font-size: 16px;" scrolldelay="300">
                    Alert : This Project is developed for Academic Study Purpose Only ! Don't Use for Commercial purpose
                    without Permission of Mayuri K.</marquee>
            </div>
                        ...
                        <tbody>
                            ...
                            while ($row = $qry->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-primary edit_payment" type="button"
                                            data-id="<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></button>
                                        <button class="btn btn-danger delete_payment" type="button"
