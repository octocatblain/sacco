		...
		<form action="" id="loan-application">
				...
				<div class="col-md-6">
					...
					<select name="plan_id" id="plan_id" class="custom-select browser-default select2">
						...
						<?php while ($row = $plan->fetch_assoc()): ?>
							<option value="<?php echo $row['id'] ?>" <?php echo isset($plan_id) && $plan_id == $row['id'] ? "selected" : '' ?> data-months="<?php echo $row['months'] ?>"
			...
			<div class="row">
				...
				<div class="form-group col-md-4  .justify-content-center">
					...
					<button class="btn btn-primary btn-block align-self-end" type="button"
