							...
							<tr>
								...
								<td>
									...
									<p>Total Payable Amount
										:<b><?php echo number_format($monthly * $plan_arr[$row['plan_id']]['months'], 2) ?></b>
									</p>
									...
									<?php if ($row['status'] == 2 || $row['status'] == 3): ?>
										<p>Date Released: <b><?php echo date("M d, Y", strtotime($row['date_released'])) ?></b>
										</p>
									<?php endif; ?>
								</td>
								<td>
									<?php if ($row['status'] == 2): ?>
										...
										<p>Penalty
											:<b><?php echo $add = (date('Ymd', strtotime($next)) < date("Ymd")) ? $penalty : 0; ?></b>
										</p>
								...
								<td class="text-center">
									<button class="btn btn-primary edit_loan" type="button"
										data-id="<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></button>
									<button class="btn btn-danger delete_loan" type="button"
